...
classes = [c1, c2, c3, c4, c13, c14, c5, c6, c7, c8, c11, c9, c10, c12]
headers = ['Name', 'C1 Status', 'C2 Status', 'C3 Status', 'C4 Status', 'C13 Status' 'Status C14',
           'Status C5',  'Status C6',  'Status C7',  'Status C8',  'Status C11',  'Status C9', 'Status C10',  'Status C12']
rows = []
